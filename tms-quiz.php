...
<head>
    ...
    <style class="tcb-lightspeed-style" id="tcb-style-template-thrive_template-32"
        ...
        @media (min-width: 300px) {
            .tve-theme-32 #content {
                padding: 0px !important;
            }

            .tve-theme-32 #wrapper {
            ...
            .tve-theme-32 .content-section [data-css="tve-u-1711c8af402"] {
                margin-top: 0px !important;
                margin-bottom: 0px !important;
            }

            .tve-theme-32 .top-section .section-background {
            ...
            .tve-theme-32 .top-section .section-content {
                display: flex;
            ...
            .tve-theme-32 .top-section [data-css="tve-u-1705cdb4152"] {
                padding-bottom: 1px !important;
            }

            :not(#tve) .tve-theme-32 .top-section [data-css="tve-u-1707753ab8f"] {
                color: rgb(255, 255, 255) !important;
                --tcb-applied-color: rgb(255, 255, 255) !important;
            }

            :not(#tve) .tve-theme-32 .top-section [data-css="tve-u-17178510bfc"] {
                padding-bottom: 0px !important;
                margin-bottom: 0px !important;
            }

            .tve-theme-32 .bottom-section .section-background {
                background-image: linear-gradient(var(--tcb-skin-color-18), var(--tcb-skin-color-18)), url("wp-content/uploads/thrive-theme/images/img_bottom_03.jpg") !important;
            ...
            .tve-theme-32 .bottom-section .section-content {
                justify-content: center;
                display: flex;
                flex-direction: column;
                --tve-color: rgb(255, 255, 255);
            ...
            .tve-theme-32 .bottom-section [data-css="tve-u-16eb7f0b034"] {
                float: none;
                z-index: 3;
                position: relative;
            ...
            .tve-theme-32 .bottom-section [data-css="tve-u-16eb7f0b034"] .tcb-button-link {
            ...
            :not(#tve) .tve-theme-32 .bottom-section [data-css="tve-u-1705d95f22d"] {
                color: rgb(255, 255, 255) !important;
                --tcb-applied-color: rgb(255, 255, 255) !important;
                padding-bottom: 0px !important;
                margin-bottom: 0px !important;
            ...
            .tve-theme-32 .bottom-section [data-css="tve-u-1705d967199"] {
                float: none;
                padding: 0px !important;
            ...
            :not(#tve) .tve-theme-32 .bottom-section [data-css="tve-u-16eb7f0b034"] .tcb-button-link span {
                font-weight: var(--tve-font-weight, var(--g-bold-weight, bold));
                text-transform: var(--tve-text-transform, uppercase);
            }

            :not(#tve) .tve-theme-32 .bottom-section [data-css="tve-u-16eb7f0b034"] .tcb-button-link {
                font-family: var(--tve-font-family, Muli);
                font-size: var(--tve-font-size, 12px) !important;
            }

            :not(#tve) .tve-theme-32 .bottom-section [data-css="tve-u-1707d9d150c"] {
        ...
        <div class="tcb-style-wrap" id="wrapper">
                                                        ...
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3052 lvl-0"
                                                            ...
                                                            <ul class="sub-menu menu-item-3052-ul">
                                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2983 lvl-1"
                                                                    ...
                                                                    id="menu-item-2983"><a href="dr-crawford-old"><span
            ...
            <div class="theme-section top-section" id="theme-top-section">
                ...
                <div class="section-content">
                    <div class="thrv_wrapper thrv_text_element" data-css="tve-u-1705cdb4152" style="">
            ...
            <div id="content">
                <div class="main-container thrv_wrapper">
                    <div class="theme-section content-section content-full-width" id="theme-content-section">
                        <div class="section-background"></div>
                        <div class="section-content">
            ...
            <div class="theme-section bottom-section" id="theme-bottom-section">
                <div class="section-background"></div>
                <div class="section-content">
                    <div class="thrv_wrapper thrv_text_element" data-css="tve-u-1705d967199" style="">
                        <h2 class="" data-css="tve-u-1705d95f22d" style="text-align: center;">Direct Your Visitors to a
                            Clear Action at the Bottom of the Page</h2>
                    </div>
                    <div class="thrv_wrapper thrv-button tve_ea_thrive_animation tve_anim_grow"
                        data-css="tve-u-16eb7f0b034" style="">
                        <a class="tcb-button-link tve_evt_manager_listen tve_et_mouseover"
                            data-tcb-events='__TCB_EVENT_[{"t":"mouseover","config":{"anim":"grow","loop":1},"a":"thrive_animation"}]_TNEVE_BCT__'
                            href="#" rel="nofollow" style="" target="_blank">
                            <span class="tcb-button-texts" style=""><span class="tcb-button-text thrv-inline-text"
                                    data-css="tve-u-1707d9d150c" style="">Clear Call To Action Button</span></span>
                        </a>
                    </div>
                </div>
            </div>
                                            ...
                                            <ul class="tcb-styled-list">
                                                ...
                                                <li class="thrv-styled-list-item" data-css="tve-u-1997fadbea5" style="">
                                                    <div class="tcb-styled-list-icon">
                                                        ...
                                                        data-css="tve-u-17c5a13235d" style=""><a class=""
                                                            data-css="tve-u-1801809aa7f" data-tcb_hover_state_parent=""
                                                            href="about-us" style="outline: none;">About Us</a></span>
                                                </li>
                                                <li class="thrv-styled-list-item" data-css="tve-u-17c5a13399f" style="">
                                                    <div class="tcb-styled-list-icon">
                                                        <div class="thrv_wrapper thrv_icon tve_no_drag tcb-no-delete tcb-no-clone tcb-no-save tcb-icon-inherit-style"
                                                ...
                                                <li class="thrv-styled-list-item" data-css="tve-u-17c5a13399f" style="">
                                                    <div class="tcb-styled-list-icon">
                                                        ...
                                                        data-css="tve-u-17c5a13235d" style=""><a class=""
                                                            ...
                                                            href="contact" style="outline: none;">Contact Us</a></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="thrv_wrapper thrv_text_element"
                                                            ...
                                                            <p data-css="tve-u-17c5a1d9444"
                                                                ...
                                                                <a class="" data-css="tve-u-17fb66c169d"
                                                                    href="hipaa-policy" style="outline: none;">HIPAA
                                                                    Policy</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tcb-col">
                                                        <div class="thrv_wrapper thrv_text_element"
                                                            ...
                                                            <p data-css="tve-u-17c5a1d9444"
                                                                style="text-align: center; color: rgb(255, 255, 255) !important; --tcb-applied-color:rgb(255, 255, 255) !important;">
                                                                <a class="" data-css="tve-u-17fb66c169d"
                                                                    href="privacy-policy" style="outline: none;">Privacy
                                                                    Policy</a>
                                                            </p>
                                                        </div>
                                                    </div>
