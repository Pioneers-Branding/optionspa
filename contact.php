...
<meta content="contact us - Options Psychiatry" name="twitter:title"/>
<meta content="(610) 741-6567" name="twitter:description"/>
...
<link href="wp-content/uploads/elementor/css/post-4808__qdefa8f72.css" id="elementor-post-4808-css" media="all" rel="stylesheet" type="text/css"/>
...
/* <![CDATA[ */
var thrive_front_localize = {"comments_form":{"error_defaults":{"email":"Email address invalid","url":"Website address invalid","required":"Required field missing"}},"routes":{"posts":"https://optionspa.com/wp-json/tcb/v1/posts","frontend":"https://optionspa.com/wp-json/ttb/v1/frontend"},"tar_post_url":"?tve=true&action=architect&from_theme=1","is_editor":"","ID":"32","template_url":"?tve=true&action=architect&from_tar=4808","pagination_url":{"template":"https://optionspa.com/contact/page/[thrive_page_number]/","base":"https://optionspa.com/contact/"},"sidebar_visibility":[],"is_singular":"1","is_user_logged_in":""};
...
<body class="wp-singular page-template page-template-elementor_header_footer page page-id-4808 wp-theme-thrive-theme ehf-header ehf-footer ehf-template-thrive-theme ehf-stylesheet-thrive-theme tve-theme-32 thrive-layout-19 thrive-no-prev-post-in-category thrive-no-next-post-in-category elementor-default elementor-template-full-width elementor-kit-4716 elementor-page elementor-page-4808">
...
<div class="elementor elementor-4808" data-elementor-id="4808" data-elementor-type="wp-page">
<div class="elementor-element elementor-element-461b371 e-con-full e-flex e-con e-parent" data-e-type="container" data-element_type="container" data-id="461b371">
<div class="elementor-element elementor-element-fb03e13 elementor-widget elementor-widget-html" data-e-type="widget" data-element_type="widget" data-id="fb03e13" data-widget_type="html.default">
<style>
        /* =========================================
        ...
        * {
        ...
        .opt-hero {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.65)), url("wp-content/uploads/2026/06/ReadingPA_11zon_z9vst3.webp");
        ...
        .opt-hero-image {
            display: none;
            /* Hidden since it's now the background */
        }
        ...
        .opt-contact-card:hover {
            transform: translateY(-8px);
            box-shadow: 0 12px 35px rgba(0, 0, 0, 0.12);
        }

        .opt-contact-card-icon {
            width: 65px;
            height: 65px;
            background: #FFE8D6;
            border-radius: 16px;
        ...
        .opt-contact-card:hover .opt-contact-card-icon {
        ...
        .opt-contact-card p:last-child {
            margin-bottom: 0;
        }

        .opt-contact-card p[style*="font-weight: 700"] {
            color: var(--primary-dark);
            font-size: 1.25rem;
            font-weight: 700;
            margin-bottom: 12px;
        ...
        /* Footer Contact Icons - Override to prevent card styling */
        .opt-footer .opt-contact-icon {
        ...
        /* Form Styling */
        .opt-contact-form-section {
            background: white;
            padding: 60px;
            border-radius: var(--radius-xl);
            box-shadow: 0 30px 80px rgba(15, 44, 58, 0.1);
        }
        ...
        .opt-form-control:focus {
            ...
            background: white;
            box-shadow: 0 0 0 4px rgba(255, 122, 21, 0.1);
        }

        .opt-textarea-control {
            min-height: 150px;
            resize: vertical;
        }
...
<span class="opt-badge-pill" style="background: rgba(255,255,255,0.1); color: white;">Get In
                        Touch</span>
<h1 class="opt-hero-title">Your Path to Wellness Starts Here.</h1>
<p class="opt-hero-subtitle">Whether you have questions about our treatments or are ready to book
                        your
                        first consultation, our team is here to support you every step of the way.</p>
</div>
</div>
</section>
<!-- Contact Detail Cards -->
<section class="opt-container">
<div class="opt-contact-grid">
<div class="opt-contact-card opt-reveal">
<div class="opt-contact-card-icon"><i class="fa-solid fa-phone"></i></div>
<h3>Phone</h3>
<p style="font-weight: 700; color: var(--primary-dark); font-size: 1.2rem;"><a href="tel:6107416567">(610) 741-6567</a></p>
<p>Mon - Fri: 9:00 AM - 5:00 PM</p>
</div>
<div class="opt-contact-card opt-reveal" style="transition-delay: 0.1s;">
<div class="opt-contact-card-icon"><i class="fa-solid fa-location-dot"></i></div>
<h3>Address</h3>
<p>2211 Quarry Drive, Suite E56</p>
<p>Reading, PA 19609</p>
</div>
<div class="opt-contact-card opt-reveal" style="transition-delay: 0.2s;">
<div class="opt-contact-card-icon"><i class="fa-solid fa-envelope"></i></div>
<h3>Email</h3>
<p style="font-weight: 700; color: var(--primary-dark);"><a href="mailto:help@optionspsychiatry.com">help@optionspsychiatry.com</a></p>
...
<div class="opt-container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: start;">
<div class="opt-reveal">
<div class="opt-contact-form-section">
<h2>Send Us a Message</h2>
<p>Fill out the form below and one of our specialists will get back to you shortly.</p>
<form accept-charset="UTF-8" action="https://app.formester.com/forms/qYHPZIOTp/submissions" method="POST">
<div class="opt-form-group">
<label class="opt-form-label">Full Name *</label>
<input class="opt-form-control" name="name" placeholder="John Doe" required="" type="text"/>
</div>
<div class="opt-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
<div class="opt-form-group">
<label class="opt-form-label">Email Address</label>
<input class="opt-form-control" name="email" placeholder="john@example.com" type="email"/>
</div>
<div class="opt-form-group">
<label class="opt-form-label">Phone Number *</label>
<input class="opt-form-control" name="phone" placeholder="(555) 000-0000" required="" type="tel"/>
</div>
</div>
<div class="opt-form-group">
<label class="opt-form-label">Service of Interest</label>
<select class="opt-form-control" name="serviceOfInterest">
...
<div class="opt-form-group">
<label class="opt-form-label">Your Message *</label>
<textarea class="opt-form-control opt-textarea-control" name="message" placeholder="How can we help you?" required=""></textarea>
</div>
<button class="opt-btn-submit" type="submit">Send Message Now</button>
</form>
</div>
</div>
<div class="opt-reveal">
<h2>Find Our Office</h2>
<p>We are conveniently located in Reading, PA, offering a tranquil environment for your recovery
                        journey.</p>
...
<p>We accept most major insurance plans and Medicare. If you have questions about your specific
                            coverage, please include your insurance provider in the message form.</p>
</div>
</div>
</div>
</section>
<!-- FAQ Section -->
<section class="opt-section opt-bg-light" id="faq">
...
<h2>Appointment &amp; Contact FAQ</h2>
</div>
<div class="opt-faq-accordion opt-reveal">
<div class="opt-faq-item">
<button class="opt-faq-question">
<span>How soon can I get an appointment?</span>
<span class="opt-faq-toggle"><i class="fa-solid fa-chevron-down"></i></span>
</button>
<div class="opt-faq-answer">
<p>We strive to see new patients as quickly as possible. Generally, we can schedule initial
                                psychiatric evaluations within 1-2 weeks. Urgent inquiries may be processed faster.</p>
</div>
</div>
<div class="opt-faq-item">
<button class="opt-faq-question">
<span>Do I need a referral to book a consultation?</span>
<span class="opt-faq-toggle"><i class="fa-solid fa-chevron-down"></i></span>
</button>
<div class="opt-faq-answer">
<p>For most services, a formal referral is not required. However, some insurance plans may
                                require one for coverage. We can assist you in determining your requirements during our
                                initial call.</p>
</div>
</div>
<div class="opt-faq-item">
<button class="opt-faq-question">
<span>Is there parking available at the office?</span>
<span class="opt-faq-toggle"><i class="fa-solid fa-chevron-down"></i></span>
</button>
<div class="opt-faq-answer">
<p>Yes, we have ample free parking located directly in front of the building at 2211 Quarry
                                Drive. The office is fully ADA accessible.</p>
</div>
</div>
</div>
</div>
...
/* <![CDATA[ */
var tve_dash_front = {"ajaxurl":"https://optionspa.com/wp-admin/admin-ajax.php","force_ajax_send":"1","is_crawler":"","recaptcha":[],"turnstile":[],"post_id":"4808"};
...
<script type="text/javascript">
/* <![CDATA[ */
var TVE_Ult_Data = {"ajaxurl":"https:\/\/optionspa.com\/wp-admin\/admin-ajax.php","ajax_load_action":"tve_ult_ajax_load","conversion_events_action":"tve_ult_conversion_event","shortcode_campaign_ids":[],"matched_display_settings":[],"campaign_ids":[],"post_id":4808,"is_singular":true,"tu_em":"","evergreen_redirects":[]};
/* ]]> */
</script>
